            ...
            if (urlPrompt && urlPrompt !== '' && urlPrompt !== 'https://') {
              ...
              extractEmbedType(urlPrompt).then(function (embed) {
                if (embed) {
                  ...
                  var embed = '<div class="ta-insert-video" ta-insert-video="' + urlLink + '" ta-insert-type="' + embed.type + '" contenteditable="false"><div class="ta-insert-video-btn" /><img src="' + embed.imageUrl + '" /></div>';
